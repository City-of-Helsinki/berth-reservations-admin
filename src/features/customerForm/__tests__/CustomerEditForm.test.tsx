...
describe('CustomerEditForm', () => {
  ...
  it('initially renders loading spinner', () => {
    const wrapper = mount(
      <MockedProvider mocks={[queryMock]}>
        <CustomerEditForm customerId={'MOCK-PROFILE'} />
      </MockedProvider>
    );
  ...
  it('renders content after loading', async () => {
    const wrapper = mount(
      <MockedProvider mocks={[queryMock]}>
        <CustomerEditForm customerId={'MOCK-PROFILE'} onSubmit={jest.fn()} onCancel={jest.fn()} />
      </MockedProvider>
    );
  ...
  it('calls update mutations on save', async () => {
    ...
    const wrapper = mount(
      ...
      <MockedProvider mocks={[queryMock, queryMock, updateProfileMock, updateBerthServicesProfileMock]}>
        <CustomerEditForm customerId={'MOCK-PROFILE'} onSubmit={onSubmit} onCancel={jest.fn()} />
      </MockedProvider>
    );
